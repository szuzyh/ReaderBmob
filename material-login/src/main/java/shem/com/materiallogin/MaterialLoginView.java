...
public class MaterialLoginView extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        loginLL=findViewById(R.id.ll_login);
        registerLL=findViewById(R.id.ll_register);
...
//        registerTitle = (TextView) findViewById(R.id.register_title);
        ...
        registerBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                Boolean isRegisterViewGone=listener.onRegister(
                        registerName,registerUser, registerPass, registerPassRep, registerBtn);
                if(isRegisterViewGone){
                    animateLogin();
                }
            }
        });
        ...
        loginBtn.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                listener.onLogin(loginUser, loginPass,loginBtn);
            }
        });
...
//            }
            ...
            String string = a.getString(R.styleable.MaterialLoginView_loginHint);
            if (string != null) {
...
//            }
            ...
            int color = a.getColor(R.styleable.MaterialLoginView_loginTextColor,
                    ContextCompat.getColor(getContext(), R.color.material_login_login_text_color));
            loginUser.getEditText().setTextColor(color);
            loginPass.getEditText().setTextColor(color);

            color = a.getColor(R.styleable.MaterialLoginView_registerTextColor,
            ...
            registerFab.setImageResource(
                    a.getResourceId(R.styleable.MaterialLoginView_registerIcon,
    ...
    private void animateRegister() {
        ...
        fabAnimation.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationStart(Animation animation) {
                int centerX=registerView.getWidth()/2;
                int centerY=registerView.getHeight()/2;
                double finalRadius=Math.hypot(centerX,centerY);
                SupportAnimator animator = getCircularRevealAnimation(registerLL,
                        centerX, centerY, 0f, (int)finalRadius);
...
//                registerFab.setVisibility(View.GONE);
    ...
    private void animateLogin() {
        ...
        int centerX=loginView.getWidth()/2;
        int centerY=loginView.getHeight()/2;
        double startRadius=Math.hypot(centerX,centerY);
        SupportAnimator animator = getCircularRevealAnimation(registerLL,
                centerX, centerY, (int)startRadius, 0F);
